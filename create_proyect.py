...
files_content = {
    ...
    "notebooks/EDA.md": "# Exploratory Data Analysis notes\n",
    "notebooks/Technical_Analysis.md": "# Technical analysis notes\n",
    "notebooks/ML_Model_Development.md": "# ML model development notes\n",
